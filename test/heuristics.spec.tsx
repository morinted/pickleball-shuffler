import { getHeuristics, getNextRound, Round } from "../src/matching/heuristics";
...
const samplePlayers = [{ name: 'a', id: 'a'}, {name: 'b', id: 'b'}, {name: 'c', id: 'c'}, {name: 'd', id: 'd'}, {name: 'e', id: 'e'}, {name: 'f', id: 'f'}]

const sampleNames = ['Tedd', 'Tan', 'Adom', 'Gret', 'Roland', 'Lewis', 'Veronica', 'Paul', 'Dan', 'Frank', 'Pier', 'David', 'Francis']
...
describe("calculateHeuristics()", () => {
  ...
  test('next round', () => {
    ...
    expect(nextRound.matches).toEqual([[['b', 'f'], ['c', 'e']]])
  })
